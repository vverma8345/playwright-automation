...
import fileHelper from '../../tests/helpers/file-helper';
import path from 'node:path';

const csvFilePath = path.resolve(`${process.cwd()}/data/make-apt-test-data.csv`);
const makeApptTestData = fileHelper.readCsvFile(csvFilePath); // -> returns 3 objests test data
